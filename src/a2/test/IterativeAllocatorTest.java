...
public class IterativeAllocatorTest {
	...
	public void basicTestTrue() {
		...
		projects.add(new Project("P0", 5));
		projects.add(new Project("P1", 5));
		projects.add(new Project("P2", 10));
		projects.add(new Project("P3", 15));
		projects.add(new Project("P4", 10));
		projects.add(new Project("P5", 5));
		donations.add(new Donation("D0", 5, new HashSet<Project>(Arrays
				.asList(projects.get(5), projects.get(1),  projects.get(4)))));
		donations.add(new Donation("D1", 5, new HashSet<Project>(Arrays
				.asList(projects.get(4)))));
		donations.add(new Donation("D2", 15, new HashSet<Project>(Arrays
				.asList(projects.get(3),  projects.get(2)))));
		donations.add(new Donation("D3", 10, new HashSet<Project>(Arrays
				.asList(projects.get(0)))));
		donations.add(new Donation("D4", 5, new HashSet<Project>(Arrays
				.asList(projects.get(0),  projects.get(5),  projects.get(2)))));
		donations.add(new Donation("D5", 10, new HashSet<Project>(Arrays
				.asList(projects.get(1),  projects.get(2),  projects.get(4)))));
		donations.add(new Donation("D6", 10, new HashSet<Project>(Arrays
				.asList(projects.get(3),  projects.get(2),  projects.get(4)))));
	...
	public void basicTestFalse() {
		...
		Assert.assertFalse(IterativeAllocator.canAllocate(actualDonations,
				actualProjects));
		checkEmptyAllocation(actualDonations,
				actualProjects);
	}
